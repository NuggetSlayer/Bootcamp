                                ...
                                <div class="footerarea__right__list">
                                    <ul>
                                        <li>
                                            <a href="#">
                                                <div class="footerarea__right__img">
                                                    <img src="{{ asset('assets/img/footer/footer__1.png') }}"
                                                        alt="footerphoto">
                                                </div>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="footerarea__right__img">
                                                    <img src="{{ asset('assets/img/footer/footer__2.png') }}"
                                                        alt="footerphoto">
                                                </div>
                                                <div class="footerarea__right__content">
                                                    <span>02 Apr 2023 </span>
                                        ...
                                        <li>
                                            <a href="#">
                                                <div class="footerarea__right__img">
                                                    <img src="{{ asset('assets/img/footer/footer__3.png') }}"
                                                        alt="footerphoto">
                                                </div>
                                                <div class="footerarea__right__content">
                                                    <span>02 Apr 2023 </span>
                    ...
                    <div class="row">
                        <div class="col-xl-3 col-lg-3">
                            <div class="copyright__logo">
                                <a href="https://html.themewin.com/"><img
                                        src="{{ asset('assets/img/logo/logo_2.png') }}" alt="logo"></a>
                            </div>
                        </div>
                        <div class="col-xl-6 col-lg-6">
...
<!-- Mirrored from html.themewin.com/edurock-preview/edurock/index.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 21 Sep 2023 08:56:26 GMT -->
