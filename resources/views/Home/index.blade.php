...
@section('content')
    <div class="herobannerarea herobannerarea__box">
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="aboutarea__img__inner text-center">
                        <div class="aboutarea__img" data-tilt>
                            <img class="aboutimg__1" src="{{ asset('assets/img/about/about_8.png') }}" alt="aboutimg">
                            <img class="aboutimg__2" src="{{ asset('assets/img/about/about_1.png') }}" alt="aboutimg">
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="herobannerarea__icon">
            <img class="hero__icon__1" src="{{ asset('assets/img/register/register__2.png') }}" alt="photo">
            <img class="hero__icon__2" src="{{ asset('assets/img/herobanner/herobanner__6.png') }}" alt="photo">
            <img class="hero__icon__3" src="{{ asset('assets/img/herobanner/herobanner__7.png') }}" alt="photo">
            <img class="hero__icon__4" src="{{ asset('assets/img/herobanner/herobanner__7.png') }}" alt="photo">
        </div>
    </div>
            ...
            <div class="row" data-aos="fade-up">
                <div class="brandarea__wraper brandarea__wraper__2">
                    <div class="brandarea__img">
                        <a href="#"><img src="{{ asset('assets/img/brand/brand_1.png') }}" alt="brand"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="#"><img src="{{ asset('assets/img/brand/brand_2.png') }}" alt="brand"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="#"><img src="{{ asset('assets/img/brand/brand_3.png') }}" alt="brand"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="#"><img src="{{ asset('assets/img/brand/brand_4.png') }}" alt="brand"></a>
                    </div>
                    <div class="brandarea__img">
                        <a href="#"><img src="{{ asset('assets/img/brand/brand_5.png') }}" alt="brand"></a>
                    </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-12 col-sm-12 col-12" data-aos="fade-up">
                    <div class="about__right__wraper__2">
                        <div class="educationarea__img" data-tilt>
                            <img class="aboutarea__2__img__1" src="{{ asset('assets/img/about/about_2.png') }}"
                                alt="education">
                            <img class="aboutarea__2__img__2" src="{{ asset('assets/img/about/about_3.png') }}"
                                alt="education">
                            <img class="aboutarea__2__img__3" src="{{ asset('assets/img/about/about_4.png') }}"
                                alt="education">
                            <img class="aboutarea__2__img__4" src="{{ asset('assets/img/about/about_11.png') }}"
                                alt="education">
                        </div>
    ...
    <div class="gridarea gridarea__2">
        <div class="container">
                ...
                <div class="col-xl-5 col-lg-5 col-md-12 col-sm-12" data-aos="fade-up">
                    <div class="section__title__2">
                        ...
                        <div class="section__title__heading__2 section__title__heading__3 heading__fontsize__2">
                            <h2>Perfect Online Course For Your Carrer</h2>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="row grid flex-wrap"  data-aos="fade-up">
                        ...
                        <div class="gridarea__wraper">
                            ...
                            <div class="gridarea__content">
                                <div class="gridarea__heading">
                                    <h3><a href="{{ route('course-detail', ['slug' => $item->slug]) }}">{{ $item->title }}</a>
                                    </h3>
                                </div>
                    ...
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            <div class="pricingarea__plan__type">
                                <h6>FREE</h6>
                                <img src="{{ asset('assets/img/icon/price__1.png') }}" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            <div class="pricingarea__plan__type">
                                <h6>BASIC</h6>
                                <img src="{{ asset('assets/img/icon/price__2.png') }}" alt="">
                            </div>
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12" data-aos="fade-up">
                    <div class="pricingarea__content__wraper">
                        <div class="pricingarea__heading">
                            <div class="pricingarea__plan__type">
                                <h6>PRO</h6>
                                <img src="{{ asset('assets/img/icon/price__3.png') }}" alt="">
                            </div>
    ...
    <div class="aboutarea__3 testimonial__area__2 sp_bottom_90 sp_top_120">
                ...
                <div class="col-xl-4 col-lg-4 col-md-6 col-sm-12 col-12 custom__review__grid" data-aos="fade-up">
                    <div class="aboutarea__content__wraper__3">
                        ...
                        <div class="aboutarea__img__3">
                            <img src="{{ asset('assets/img/about/about_5.png') }}" alt="about">
        ...
        <div class="aboutarea__img__3">
            <img class="aboutarea__3__img__1" src="{{ asset('assets/img/about/about_6.png') }}" alt="about">
            <img class="aboutarea__3__img__2" src="{{ asset('assets/img/about/about_7.png') }}" alt="about">
            <img class="aboutarea__3__img__3" src="{{ asset('assets/img/about/about_9.png') }}" alt="about">
        </div>
    </div>
@endsection
